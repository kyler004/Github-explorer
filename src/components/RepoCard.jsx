...
const RepoCard = ({
  ...
  const statsLayout = isEnhanced
    ? "flex flex-wrap items-center gap-4 text-sm gap-4 text-gray-500"
  ...
  return (
    <div className={baseClasses}>
      <div className="flex items-center justify-between mb-3">
        ...
        {repo.private && (
          <span
            className={`ml-2 px-3 py-1 text-xs bg-yellow-600 text-white rounded ${isEnhanced ? "shrink-0" : ""}`}
          >
            Private
          </span>
        )}
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className={statsLayout}>
          ...
          <span className="flex items-center">
            <FaClock className="w-4 h-4 mr-1"></FaClock>
